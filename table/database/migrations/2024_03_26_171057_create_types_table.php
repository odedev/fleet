...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('types', function (Blueprint $table) {
            ...
            $table->boolean('Booleans')->comment('Booleans');
            $table->string('Strings', 64)->comment('Strings');
            $table->text('Texts')->comment('Texts');
            $table->integer('Integers')->comment('Integers');
            $table->decimal('Floats', 12, 4)->comment('Floats');
            $table->dateTime('Dates', 3)->comment('Dates');
            $table->integer('Enums')->comment('Enums');
            $table->char('Models', 32)->comment('Models');
            $table->json('Jsons')->comment('Jsons');
            $table->char('Files', 32)->comment('Files');
            ...
            $table->primary('id');
            $table->index(['remark', 'updated_count']);
        });
    }
